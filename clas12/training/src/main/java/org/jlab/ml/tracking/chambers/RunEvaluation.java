...
public class RunEvaluation {
    ...
    public static double evluate(INDArray output){
        double w = 0.0;
        double mw = 0.0;
        Axis   theta = new Axis(50,-25.0,25.0);
        for(int i = 0; i < 50; i++){
            double weight = output.getDouble(0, i);
            w += weight;
            mw += theta.getBinCenter(i)*weight;
        }
        return mw/w;
    }
    ...
    public static void main(String[] args){
       ...
       File file = new File("network_chambers.nnet");
        ...
        try {
            ...
            H1F         histo = new H1F("h1",100,-1.0,1.0);
